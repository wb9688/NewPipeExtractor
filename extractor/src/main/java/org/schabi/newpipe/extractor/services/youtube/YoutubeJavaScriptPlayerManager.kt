...
object YoutubeJavaScriptPlayerManager {
    ...
    fun getSignatureTimestamp(videoId: String?): Int? {
        ...
        try {
            cachedSignatureTimestamp =
                    YoutubeSignatureUtils.getSignatureTimestamp(cachedJavaScriptPlayerCode)!!.toInt()
    ...
    fun getUrlWithThrottlingParameterDeobfuscated(
        ...
        val cacheResult: String? = CACHED_THROTTLING_PARAMETERS.get(
        ...
        if (cachedThrottlingDeobfuscationFunction == null) {
            try {
                cachedThrottlingDeobfuscationFunctionName = YoutubeThrottlingParameterUtils.getDeobfuscationFunctionName(
                        cachedJavaScriptPlayerCode)
                cachedThrottlingDeobfuscationFunction = YoutubeThrottlingParameterUtils.getDeobfuscationFunction(
                        cachedJavaScriptPlayerCode,
        ...
        try {
            val deobfuscatedThrottlingParameter: String? = JavaScript.run(
