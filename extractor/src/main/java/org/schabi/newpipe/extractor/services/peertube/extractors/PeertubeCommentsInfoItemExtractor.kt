...
class PeertubeCommentsInfoItemExtractor(@field:Nonnull @param:Nonnull private val item: JsonObject,
                                        private val children: JsonArray?,
                                        @field:Nonnull @param:Nonnull private override val url: String?,
                                        @field:Nonnull @param:Nonnull private val baseUrl: String?,
