...
class AudioStream private constructor(id: String,
    ...
    () {
        ...
        private var averageBitrate: Int = UNKNOWN_BITRATE
        ...
        fun build(): AudioStream {
            ...
            if (content == null) {
                throw IllegalStateException(("The content of the audio stream has been not set "
            ...
            return AudioStream(id!!, content!!, isUrl, mediaFormat, deliveryMethod!!, averageBitrate,
