...
import org.schabi.newpipe.extractor.services.youtube.YoutubeParsingHelper.areHardcodedClientVersionAndKeyValid
import org.schabi.newpipe.extractor.services.youtube.YoutubeParsingHelper.extractAudioTrackType
import org.schabi.newpipe.extractor.services.youtube.YoutubeParsingHelper.extractCachedUrlIfNeeded
import org.schabi.newpipe.extractor.services.youtube.YoutubeParsingHelper.isHardcodedYoutubeMusicKeyValid
import org.schabi.newpipe.extractor.services.youtube.YoutubeParsingHelper.parseDurationString
...
class YoutubeParsingHelperTest {
    ...
    fun testAreHardcodedClientVersionAndKeyValid() {
        Assertions.assertTrue(areHardcodedClientVersionAndKeyValid(),
                "Hardcoded client version and key are not valid anymore")
    }

    @Test
    @Throws(IOException::class, ExtractionException::class)
    fun testAreHardcodedYoutubeMusicKeysValid() {
        Assertions.assertTrue(isHardcodedYoutubeMusicKeyValid,
    ...
    companion object {
        ...
        fun setUp() {
            ...
            init(DownloaderFactory.getDownloader(RESOURCE_PATH + "youtubeParsingHelper"))
        }
    }
}
